function jsqrscanner() {
    var O = 'bootstrap',
        ...
        _b = 'jsqrscanner.devmode.js',
        ac = '../assets/12BF17C68AEA5DB5EB3A47A5951683F8',
        bc = '../assets/2DC958B56AAC6D2F3A3690430AC33F88',
        cc = '../assets/BFA98128C99E543CB431D49C278DF0B6',
        dc = '../assets/E6E6E3F2A803616D0A10675BBD03B058',
        ec = '../assets/E89CC63524AD10EE91EECDEBE4A7DFEE',
        fc = ':',
        gc = '.cache.js',
        hc = 'loadExternalRefs',
        ic = 'end',
        ...
        kc = 'file:',
        lc = '_gwt_dummy_',
        mc = '__gwtDevModeHook:jsqrscanner',
    ...
    function A(k) {
        ...
        if (jsqrscanner.__errFn) {
            n.onerror = function() {
                jsqrscanner.__errFn(S, new Error(nb + code))
            }
        }
